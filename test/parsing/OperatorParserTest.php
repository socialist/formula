...
class OperatorParserTest extends TestCase {
  ...
  public function provideOperators(): array {
    // @formatter:off
    return [
      ["a::b", '::', 1, OperatorType::Infix],
      ['(int[]|bool)', '(int[]|bool)', 0, OperatorType::Prefix],
//       ['(a,b,c)', '(a,b,c)', 0, OperatorType::Infix],
//       ['[c]', '[c]', 0, OperatorType::Infix],
      ['a.b', '.', 1, OperatorType::Infix],
      ['a++', '++', 1, OperatorType::Postfix],
      ['a--', '--', 1, OperatorType::Postfix],
      ['++a', '++', 0, OperatorType::Prefix],
      ['--a', '--', 0, OperatorType::Prefix],
      ['a+b', '+', 1, OperatorType::Infix],
      ['a-b', '-', 1, OperatorType::Infix],
      ['+b', '+', 0, OperatorType::Prefix],
      ['(+b)', '+', 1, OperatorType::Prefix],
      ['-b', '-', 0, OperatorType::Prefix],
      ['(-b)', '-', 1, OperatorType::Prefix],
      ['!', '!', 0, OperatorType::Prefix],
      ['a*b', '*', 1, OperatorType::Infix],
      ['a/b', '/', 1, OperatorType::Infix],
      ['a%b', '%', 1, OperatorType::Infix],
      ['a<b', '<', 1, OperatorType::Infix],
      ...
      ['a+=b', '+=', 1, OperatorType::Infix],
      ['a^=b', '^=', 1, OperatorType::Infix],
      ['a instanceof b', 'instanceof', 1, OperatorType::Infix],
    ];
  // @formatter:on
  }
